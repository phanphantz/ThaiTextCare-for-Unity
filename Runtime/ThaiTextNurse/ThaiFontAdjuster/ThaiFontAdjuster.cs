...
namespace PhEngine.ThaiTextCare
{
    public static class ThaiFontAdjuster
    {
        ...
        public static string Adjust(string s, ThaiGlyphCorrection correction)
        {
            ...
            {
                var c = s[i];
                if (correction == ThaiGlyphCorrection.FullC90)
                {
                    // [base] ~ [top]
                    if (IsTop(c) && i > 0)
                    {
                ...
                else if (correction == ThaiGlyphCorrection.YoorYingAndToorTaan)
                {
                    // [YO YING] [lower] -> [YO YING w/o lower] [lower]
